...
public class GifPlayer extends View {
    ...
    public GifPlayer(Context context) throws IOException {
        super(context);
    }

    public GifPlayer(Context context, AttributeSet attrSet) throws IOException{
        super(context, attrSet);
    }

    public GifPlayer(Context context, AttributeSet attrSet, int newStyle) throws IOException {
